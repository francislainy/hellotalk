...
public interface FollowshipRepository extends JpaRepository<FollowshipEntity, UUID> {
    ...
    List<FollowshipEntity> findFollowshipsByUserFromId(UUID userFromId);
    ...
    List<FollowshipEntity> findFollowingsByUserToId(UUID userToId);
    ...
    Optional<FollowshipEntity> findByUserFromIdAndUserToId(UUID userFromId, UUID userToId);
