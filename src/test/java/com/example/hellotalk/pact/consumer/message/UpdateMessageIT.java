...
class UpdateMessageIT {

    Map<String, String> headers = new HashMap<>();

    String path = "/api/v1/ht/messages/";
    UUID messageId = UUID.fromString("a2f6bea6-4684-403e-9c41-8704fb0600c3");
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        DslPart bodyReturned = new PactDslJsonBody()
                ...
                .uuid("userFromId", "d3f6bea6-4684-403e-9c41-8704fb0600c0")
                .uuid("userToId", "f1f6bea6-4684-403e-9c41-8704fb0600c0")
                .close();

        return builder
                .given("A message exists")
                .uponReceiving("A request to update a message")
    ...
    void runTest() {
        ...
        Response response = getMockRequest(headers).body(message).put(path + messageId);
