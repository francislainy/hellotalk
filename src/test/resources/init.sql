...
VALUES ('d3256c76-62d7-4481-9d1c-a0ccc4da380f', 'usernamed', 'passwordd', '2022-12-01', 17121989, 'anyGender',
        'anyHandle', 'anyName',
...
INSERT INTO users (id, username, password, creation_date, dob, gender, handle, name, native_language, occupation,
                   places_to_visit,
                   self_introduction, status, subscription_type, target_language, hometown_id)
VALUES ('ca3569ee-cb62-4f45-b1c2-199028ba5562', 'usernamec', 'passwordc', '2022-12-01', 17121989, 'anyGender',
        'anyHandle', 'anyName',
        'anyNativeLanguage', 'anyOccupation', 'anyPlacesToVisit',
        'anySelfIntroduction', 'anyStatus', 'anySubscriptionType', 'anyTargetLanguage',
        '3bfff94a-b70e-4b39-bd2a-be1c0f898556');
...
INSERT INTO comment(id, creation_date, last_updated_date, text, user_id, moment_id)
